            ...
            if ($challenge_type != 'indiviual ') {
                ...
                if ($query) {
                    ...
                    if ($query) {
                        ...
                        $sqlchallenge_groups = "INSERT into challenges_groups(noti_type_id,challenge_id,group_id,status)VALUES('$noti_type_id','$challenge_id','$group_id','requested')";
                        $querychallenge_groups = mysqli_query($conn, $sqlchallenge_groups);
